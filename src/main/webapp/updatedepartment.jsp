...
<body>
 <div id="wrapper">
  ...
  <div class="backbtn_container">
    <a href="departments.jsp" class="back_btn">Back</a>
  </div>
  <form action="updatedepartment" method="post">
    <% ApplicationContext context = new ClassPathXmlApplicationContext("ApplicationContext.xml");
	   DepartmentDao departmentDao = (DepartmentDao) context.getBean("departmentDao");
	   int departmentid = Integer.parseInt(request.getParameter("update_id"));
    ...
    <div class="mb-3">
	  ...
	  <input type="text" value="<%= d.getName() %>" class="form-control" name="name" id="exampleFormControlInput1" >
	</div>
    <div class="mb-3">
	  <label for="exampleFormControlInput1" class="form-label">Code</label>
	  <input type="text" value="<%= d.getCode() %>" class="form-control" name="code" id="exampleFormControlInput1">
	</div>
	
	<div class="submit_btn">
	  <input type="submit" value="Update Department" style="border:none;background:green;">
	</div>
   <% }} %>
  </form>
 </div> 
