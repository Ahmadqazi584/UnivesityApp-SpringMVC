 ...
 <div id="wrapper">
  ...
  <form action="adddepartment" method="post">
    <div class="mb-3">
	  ...
	  <input type="text" class="form-control" name="name" id="exampleFormControlInput1" placeholder="enter your department name">
	</div>
    <div class="mb-3">
	  <label for="exampleFormControlInput1" class="form-label">Department Code</label>
	  <input type="text" class="form-control" name="code" id="exampleFormControlInput1" placeholder="enter your department code">
	</div>
	
	<div class="submit_btn">
	  <input type="submit" value="Add Department" style="border:none;">
	</div>
  </form>
 </div> 
 <script>
